...
Процедура ТоварыСкладПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Элементы.Товары.ТекущиеДанные.Склад) Тогда
		Элементы.Товары.ТекущиеДанные.Подразделение = ПолучитьЗначениеРеквизитаОбъекта(Элементы.Товары.ТекущиеДанные.Склад, "Подразделение");
	Иначе
		Элементы.Товары.ТекущиеДанные.Подразделение = ПредопределенноеЗначение("Справочник.СтруктураПредприятия.ПустаяСсылка");
	КонецЕсли;	
...
Процедура УстановитьУсловноеОформление()
	...
	ОбщегоНазначенияКлиентСервер.ДобавитьПростойЭлементУсловногоОформления(ЭтотОбъект, "ТоварыСклад", "ТолькоПросмотр",
		Истина, "Объект.Товары.ТипНоменклатуры", ВидСравненияКомпоновкиДанных.Равно, Перечисления.ТипыНоменклатуры.Услуга);	
			
	ОбщегоНазначенияКлиентСервер.ДобавитьПростойЭлементУсловногоОформления(ЭтотОбъект, "ТоварыПодразделение", "ТолькоПросмотр",
		Истина, "Объект.Товары.ТипНоменклатуры", ВидСравненияКомпоновкиДанных.Равно, Перечисления.ТипыНоменклатуры.Товар);					
